...
- **[modules/distillation-science.md](modules/distillation-science.md)**: Comprehensive spirits guide — still design, spirit runs and cuts, gin production and botanicals, **world whiskeys** (bourbon/Tennessee/rye, Scotch regions, Irish/Japanese/Canadian), mash bill science, **vodka** (history, production, regional styles), **brandy** (Cognac/Armagnac/Calvados/Pisco/Grappa), **rum** (regional styles from Jamaica to Martinique, agricole, cachaça), **tequila and mezcal**, liqueurs, aquavit, absinthe, bitters (from Hicks/Parsons and Owens/Dikty), **arrack** (coconut/toddy arrack production and aging, Batavia arrack with *Amylomyces rouxii* fermentation, Middle Eastern arak triple distillation, regional variants, Swedish punsch history), **ouzo** (copper pot still production, PDO regulations, Lesbos/Plomari distilleries, brand profiles), **anise spirits** (raki, pastis, sambuca, mastika, chinchon, louche effect chemistry)
- **[modules/korean-japanese-spirits.md](modules/korean-japanese-spirits.md)**: Korean and Japanese spirits — **soju** (history, traditional jeungryusik vs modern huiseoksik, key brands, drinking culture/etiquette, legal classification, cocktail use), **expanded shochu** (honkaku vs korui, base ingredients with character profiles, koji types and flavor impact, awamori/kusu aging, geographic indications, serving styles, shochu vs soju comparison), **makgeolli** (nuruk fermentation science, pasteurized vs saeng, craft movement, related beverages: cheongju, dongdongju, yakju)
